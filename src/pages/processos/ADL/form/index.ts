...
import { andamentoadl, andamentoCogeradl, motivoAberturaadl, prorogacao, tipoBoletim } from 'src/config/selects'
export const selects = { andamentoCogeradl, andamentoadl, motivoAberturaadl, prorogacao, tipoBoletim }
