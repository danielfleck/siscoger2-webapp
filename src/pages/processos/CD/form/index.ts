...
import { andamentocd, andamentoCogercd, motivoAberturacd, prorogacao, tipoBoletim } from 'src/config/selects'
export const selects = { andamentoCogercd, andamentocd, motivoAberturacd, prorogacao, tipoBoletim }
