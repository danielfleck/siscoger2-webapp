    ...
    children: [
      {
        ...
        children: [
          ...
          { path: 'apagados', component: () => import('pages/processos/CJ/list/Apagados.vue'), meta: { auth: true, ...cjRules.toShow } },
          ...
          { path: 'resultado', component: () => import('pages/processos/CJ/list/Resultado.vue'), meta: { auth: true, ...cjRules.toShow } }
        ]
      }
    ]
  },
